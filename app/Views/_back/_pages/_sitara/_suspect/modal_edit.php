        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_nik" name="suspect_nik" placeholder="Masukkan (16 digit) NIK Tersangka" value="<?= $suspect_nik; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_name" name="suspect_name" placeholder="Masukkan Nama Lengkap Tersangka" value="<?= $suspect_name; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="date" class="form-control" id="suspect_ttl" name="suspect_ttl" placeholder="Masukkan TTL Tersangka" value="<?= $suspect_ttl; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_nationality" name="suspect_nationality" placeholder="Masukkan Kebangsaan Tersangka" value="<?= $suspect_nationality; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_religion" name="suspect_religion" placeholder="Masukkan Agama Tersangka" value="<?= $suspect_religion; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_profession" name="suspect_profession" placeholder="Masukkan Pekerjaan Tersangka" value="<?= $suspect_profession; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_education" name="suspect_education" placeholder="Masukkan Pendidikan Tersangka" value="<?= $suspect_education; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" id="suspect_address" name="suspect_address" rows="3"><?= $suspect_address; ?></textarea>
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="email" class="form-control" id="suspect_email" name="suspect_email" placeholder="nama@contoh.com" value="<?= $suspect_email; ?>">
                ...
                <div class="form-group row pb-3 pt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="suspect_phonenumber" name="suspect_phonenumber" placeholder="08xx xxxx xxxx" value="<?= $suspect_phonenumber; ?>">
